...
const dict = {
  ru: {
    ...
    tutorial: {
      ...
      step1Body: 'Кружок слева превращает задание в выполненное. +10 XP за каждое, копится в streak.',
      step2Title: 'AI бонус Premium',
      step2Body: 'Premium-пользователи получают доп. задание в день — +25 XP сверху.',
      step3Title: 'Лиги, сезоны, друзья',
      step3Body: 'Вкладка «Прогресс» — недельные лиги, сезон 4 нед., лидерборд по друзьям.',
      step4Title: 'Настройки и шестерёнка',
      step4Body: 'Сверху — твои XP/серия. Шестерёнка → время напоминания, имя, язык.',
    },
    subscription: {
      title: 'Premium',
  ...
  en: {
    ...
    tutorial: {
      ...
      step1Body: 'The circle on the left marks a task done. +10 XP each, keeps your streak alive.',
      step2Title: 'AI bonus (Premium)',
      step2Body: 'Premium gets one extra AI-generated stretch task per day — +25 XP on top.',
      step3Title: 'Leagues, seasons, friends',
      step3Body: 'Progress tab — weekly leagues, 4-week seasons, friend leaderboard.',
      step4Title: 'Settings & gear',
      step4Body: 'Top row shows your XP / streak. Gear opens reminder time, name, language.',
    },
    subscription: {
      title: 'Premium',
